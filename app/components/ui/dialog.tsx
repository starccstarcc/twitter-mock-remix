...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-0 top-0 z-50 h-screen w-screen bg-background px-6 py-4 md:left-[50%] md:top-[50%] md:h-auto md:w-1/2 md:-translate-x-[50%] md:-translate-y-[50%] md:rounded-lg md:pb-8 ',
        className,
      )}
      {...props}
    >
